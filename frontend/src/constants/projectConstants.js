...
export const PROJECT_CREATE_RESET = 'PROJECT_CREATE_FAIL';
...
export const PROJECT_CREATE_TASK_REQUEST = 'PROJECT_CREATE_TASK_REQUEST';
export const PROJECT_CREATE_TASK_SUCCESS = 'PROJECT_CREATE_TASK_SUCCESS';
export const PROJECT_CREATE_TASK_FAIL = 'PROJECT_CREATE_TASK_FAIL';
export const PROJECT_CREATE_TASK_RESET = 'PROJECT_CREATE_TASK_RESET';