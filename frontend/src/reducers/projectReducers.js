...
export const projectListReducer = (state = { projects: [] }, action) => {
    switch(action.type) {
        ...
        case PROJECT_LIST_SUCCESS:
            return { loading: false, projects: action.payload.projects, pages: action.payload.pages, page: action.payload.page }
...
export const projectCreateReviewReducer = (state = { }, action) => {
    switch(action.type) {
        case PROJECT_CREATE_TASK_REQUEST:
            return { loading: true }
        case PROJECT_CREATE_TASK_SUCCESS:
            return { loading: false, success: true }
        case PROJECT_CREATE_TASK_FAIL:
            return { loading: false, error: action.payload }
        case PROJECT_CREATE_TASK_RESET:
            return { }
        default:
            return state
    }
